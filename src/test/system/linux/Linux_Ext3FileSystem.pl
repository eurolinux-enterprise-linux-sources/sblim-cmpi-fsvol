...
my $className="Linux_Ext3FileSystem.instance";
my $INST_FILE;
...
my %list;
keys(%list) = `cat /etc/mtab | grep -c ext3`+`cat /etc/fstab | grep -c ext3`;
my @out;
my $out;
